...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($password, $hasil['password'])) {
            ...
            //jika login benar arahkan ke halaman selanjutnya
            header("Location: dashboard.php");
            exit();
        }
    }
    // jika ada username / login salah 
    $error = true;
}
...
<body class="text-center">
    ...
    <main class="form-signin">
        ...
        <form action="" method="POST">
            ...
            <h1 class="h4 fw-normal"><b>SISTEM INFORMASI MANAJEMEN <br> TOKO KOMPUTER</b></h1>
            ...
            <button class="w-100 btn btn-lg btn-primary mt-3" type="submit" name="login"> <i class="bi bi-box-arrow-in-right"></i> </button>
